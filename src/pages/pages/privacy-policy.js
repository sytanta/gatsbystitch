...
import FooterPageContainer from "../../components/pages/footer-page-layout"

const PrivacyPage = () => (
  <Layout>
    <SEO title="Terms and Conditions" />
    <FooterPageContainer templateClass="page-legal">
      <p>
        This Privacy Policy describes how your personal information is
        collected, used, and shared when you visit or make a purchase from{" "}
        <a href="https://www.taylorstitch.com/">
      ...
      <ul>
        <li>
          <a href="https://www.bouncepilot.com/opt-out/">BouncePilot</a>
        </li>
        <li>
        ...
        <li>
          <a href="https://www.liveramp.com/opt_out">LiveRamp</a>
        </li>
        <li>
          <a href="https://www.securedvisit.com/donottrack/">SecuredVisit</a>
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        <a href="mailto:hello@taylorstitch.com">hello@taylorstitch.com</a> or by
        mail using the details provided below:
      </p>
      <p>290 Utah St., San Francisco, CA, 94103, United States</p>
    </FooterPageContainer>
  </Layout>
)
