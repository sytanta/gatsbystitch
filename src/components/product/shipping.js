      ...
      <div id="shipping-modal-content">
        <div class="left">
          <div class="full">
            <div class="faq-row">
              ...
              <div class="answer">
                <p>
                  All domestic U.S. orders for in-stock items are shipped free
                  of charge.
                </p>
                <p>
                  Please allow two business days to fulfill and issue you a a
                  tracking number (unless there is a red delayed date posted in
                  the product description). Once you receive your tracking
                  number, you should expect&nbsp;your package within 2–4
                  business days.
                </p>
                <p>
                  Please note that while we&nbsp;will issue you a tracking
                  number once we have sent out your package, you may not be able
                  to track your package immediately. You must wait until your
                  package is scanned in by the Postal Service for tracking to
                  activate.
                </p>
                <p>
                  Orders placed for Workshop items require a shipping fee of $6.
                  These orders will ship during the&nbsp;estimated shipping
                  period noted on the product page.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="right">
            ...
            <div class="faq-row">
              ...
              <div class="answer">
                <p>
                  ...
                  including but not limited to country of shipping destination
                  and product price.
                </p>
                <p>
                  We cannot guarantee delivery time as it depends on how
                  efficient your country’s customs agents are. All international
                  packages are trackable once they are scanned in by the
                  postman.
                </p>
              </div>
            </div>
          ...
          <div class="bottom">
            <h3>Returns</h3>
            <p>
              To start the process, click the button in your Shipping or
              Delivery confirmation email. You can return an item for a full
              refund or store credit within 60 days of having received it. More
              on that <a href="/pages/returns">here</a>.{" "}
            ...
            <p>
              ...
              condition (unworn, unwashed, unaltered). If something funny
              happens with an item, just reach out to us. We’ll make it right.
            </p>
